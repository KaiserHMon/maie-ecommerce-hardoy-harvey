...
<div class="row align-items-center g-5 py-5">
    <div class="col-lg-12 text-center">
        <h1 class="display-3 fw-bold lh-1 mb-3">El Arte de la Presencia</h1>
...
<section class="section-donde-encontrarnos py-5" style="background-color: #F6F3EE;">
<div class="container">
